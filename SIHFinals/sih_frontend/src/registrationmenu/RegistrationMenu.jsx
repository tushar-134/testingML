    ...
    <div className="flex items-center justify-center p-6 bg-gray-50">
      <div className="w-full max-w-lg space-y-6">
        <div
          ...
          className={`cursor-pointer bg-white rounded-3xl p-8 transition-all duration-300 ${selectedOption === "resume"
              ? "shadow-2xl ring-4 ring-blue-500 ring-opacity-50 scale-105"
              : "shadow-lg hover:shadow-xl hover:scale-102"
            }`}
        >
          <div className="flex flex-col items-center text-center">
            <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${selectedOption === "resume" ? "bg-blue-500" : "bg-blue-100"
              }`}>
        ...
        <div
          ...
          className={`cursor-pointer bg-white rounded-3xl p-8 transition-all duration-300 ${selectedOption === "form"
              ? "shadow-2xl ring-4 ring-orange-500 ring-opacity-50 scale-105"
              : "shadow-lg hover:shadow-xl hover:scale-102"
            }`}
        >
          <div className="flex flex-col items-center text-center">
            <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-4 ${selectedOption === "form" ? "bg-orange-500" : "bg-orange-100"
              }`}>
        ...
        <div className="pt-4">
          <button
            ...
            className={`block w-full py-4 rounded-2xl font-bold text-lg transition-all duration-300 ${selectedOption
